...
require_relative "lib/jp_train_lines_and_stations_data/version"

Gem::Specification.new do |spec|
  spec.name = "jp_train_lines_and_stations_data"
  spec.version = JpTrainLinesAndStationsData::VERSION
